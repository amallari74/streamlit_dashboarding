...
def pages(cookies):
    ...
    landing_pages_dict = {
        ...
        "Subscription Level Variances": st.Page("landing_pages/subscription_level_variance_landing.py", title="Subscription Level Variances", icon=":material/data_thresholding:")
    ...
    if st.session_state.nav_section == "Billing":
        if auth_util.check_for(roles.BILLING_RUN_ROLES):
            ...
            all_pages["Billing Analytics"] = [
                ...
                st.Page("billing_run/pages/tax_report_monitoring.py", title="Tax Report Monitoring", icon=":material/timer:", url_path="tax_report_monitoring")            ]
        ...
        if auth_util.check_for(roles.DIAGNOSTICS_ROLES):
            ...
            diagnostics.append(st.Page("diagnostics/invoice_analytics_monitoring.py", title="Invoice Analytics", icon=":material/calendar_clock:"))
    ...
    elif st.session_state.nav_section == "Subscription Level Variances":
        all_pages["Observability Reports"] = [
            st.Page("variance/pages/arrears_variance_by_vendor.py", title="Arrears Variance By Vendor",
                    icon=":material/compare_arrows:", url_path="arrears_variance_by_vendor"),
            st.Page("variance/pages/arrears_variance_by_partner_monitoring.py", title="Arrears Variance by Partner", icon=":material/timer:", url_path="arrears_variance_by_partner_monitoring")
        ]
