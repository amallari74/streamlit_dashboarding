...
def init():
    ...
    document_generation_df = task_dfs["Document Generation"]
    ...
    task_categories = [
        ...
        add_category('document_generation', document_generation_df,
            "Tasks that generate partner and company PDF and CSV versions into S3 after generation using postProcessInvoice method.")
    ]
    ...
    with st.expander("ℹ️ About Billing Tasks"):
        ...
        | **Document Generation** | `postProcessInvoice` | Generates Partner and Company PDF and CSV versions into S3 after generation|
