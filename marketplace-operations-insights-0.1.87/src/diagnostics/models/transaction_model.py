...
def fetch_cube_js_missing_subscriptions(invoice_date):
    query = """
      SELECT 
          transaction_month,
          partner_id,
          ...
          partner_guid,
          company_guid
        FROM billing_run_context__missing_subscription
    WHERE transaction_month = :invoice_date
    """
    params = {"invoice_date": invoice_date}
    return db_util.query(query, params=params, db='cube')